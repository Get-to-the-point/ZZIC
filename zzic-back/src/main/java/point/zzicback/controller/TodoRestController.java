...
public class TodoRestController {
    ...
    @GetMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public Todo getTodo(@Parameter(description = "조회할 Todo의 ID") @PathVariable Long id) {
    ...
    public void createTodo(@Parameter(description = "등록할 Todo 정보") @Valid @RequestBody CreateTodoRequest createTodoRequest) {
        Todo todo = new Todo();
    ...
    public void updateTodo(@Parameter(description = "수정할 Todo의 ID") @PathVariable Long id,
    ...
    @DeleteMapping("/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteTodo(@Parameter(description = "삭제할 Todo의 ID") @PathVariable Long id) {
